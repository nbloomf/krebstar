...
> import           Kreb.Prop (Arb(..), Prune(..), Positive(..), listOf, pickFrom4)
...
> instance Fmt.Display Span where
>   display x = case x of
>     Fixed0   -> "Fixed0"
>     Fixed1   -> "Fixed1"
>     Fixed2   -> "Fixed2"
...
> instance Fmt.Display (ScreenOffset w t) where
>   display x = case x of
>     NoNewlines z -> "NoNewlines" <+> display z
>     WithNewlines a u b -> "WithNewlines"
>       <+> display a <+> display u <+> display b
