...
> import qualified Kreb.Struct.Data.RunLengthEncoded as RLE
> 
...
>   :: Span
>   -> NonNegative Int
>   -> Sample (RLE.RunLengthEncoded Span)
...
>     [ krebProp "k == withWidth k toWidth"
>         prop_ScreenOffset_withWidth_toWidth
>     , krebProp "k == withTab k toTab"
...
>   provisio
>     [ ("input not empty", not $ isEmpty xs)
>     , ("width >= 2", width >= 2)
...
> test_TakeChunk_width_succeeds =
>   krebProp "If span width > screen width, takeChunk succeeds"
>     prop_TakeChunk_width_succeeds
...
>     case takeChunk width tab xs of
>       Nothing -> True
>       Just (as, _) -> not $ isEmpty as
> 
> test_TakeChunk_take_not_empty :: TestTree
> test_TakeChunk_take_not_empty =
>   krebProp "taken chunk is not empty"
>     prop_TakeChunk_take_not_empty
...
> test_TakeChunk_cat_factor =
>   krebProp "takeChunk is a cat factorization"
>     prop_TakeChunk_cat_factor
...
> test_TakeChunk_shrink_tail =
>   krebProp "takeChunk shrinks its input"
>     prop_TakeChunk_shrink_tail
...
> test_TakeChunk_length =
>   krebProp "takeChunk preserves length"
>     prop_TakeChunk_length
...
> test_TakeChunk_rest_empty =
>   krebProp "remainder is only empty if taken chunk is full"
>     prop_TakeChunk_rest_empty
...
> test_TakeChunks_cat_factor =
>   krebProp "takeChunks yields a cat factorization"
>     prop_TakeChunks_cat_factor
...
> test_TakeChunks_take_size_upper_bound =
>   krebProp "taken chunk size is bounded above"
>     prop_TakeChunks_take_size_upper_bound
...
> test_TakeChunks_take_size_lower_bound =
>   krebProp "taken chunk size is bounded below"
>     prop_TakeChunks_take_size_lower_bound
...
> test_TakeChunks_rest_size_upper_bound =
>   krebProp "rest size is bounded above"
>     prop_TakeChunks_rest_size_upper_bound
...
>     , krebProp "left identity is unique" $
>         check_prop_unique_left_neutral_for e op
>     , krebProp "right identity is unique" $
...
> 
>     , krebProp "well defined on valid coords" $
