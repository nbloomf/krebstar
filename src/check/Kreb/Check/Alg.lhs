...
>       else accept
>     else reject "claimed left neutral is not"
> 
...
>       then claimEqual e1 e2
>       else accept
>     else reject "claimed right neutral is not"
> 
> -- f z x == z
...
>     then accept
>     else reject "not antirespectful"
